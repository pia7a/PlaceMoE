...
> **适用范围：**VeOmni 当前固定使用 `transformers==5.2.0`，并在
...
> [docs/transformers_v5/patchgen.md](../../transformers_v5/patchgen.md) 和
...
在 [veomni/data/multimodal/data_transform.py](../../../veomni/data/multimodal/data_transform.py)
