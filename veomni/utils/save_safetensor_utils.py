...
from veomni.distributed.moe.hiermoe import hiermoe_has_non_identity_placement
...
def save_hf_safetensor(
    ...
    if hiermoe_has_non_identity_placement():
        raise RuntimeError(
            "Cannot export HuggingFace safetensors after HierMoE Expert Swap changes expert placement. "
            "Use the DCP checkpoint, which stores HierMoE placement state, or disable HF weight export for this run."
        )
