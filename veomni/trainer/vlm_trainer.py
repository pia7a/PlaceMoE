...
class VLMTrainer:
    ...
    def train_step(
        ...
        self.base.full_timing_profiler.begin_step(
            self.base.state.global_step,
            metadata={"run_kind": "pretrain", "trainer": type(self).__name__},
        )

        with self.base._full_profile_range("data_wait"):
        ...
        for micro_step, micro_batch in enumerate(micro_batches):
            ...
            with self.base._full_profile_range("micro_batch", {"micro_step": micro_step}):
        ...
        with self.base._full_profile_range("lr_scheduler"):
            self.base.lr_scheduler.step()
        with self.base._full_profile_range("zero_grad"):
            self.base.optimizer.zero_grad()

        self.base.run_hiermoe_expert_swap()
        self.base.full_timing_profiler.end_step(
            metadata={"loss": float(total_loss), "grad_norm": _scalar_float(grad_norm)}
        )
