...
class TextDPOTrainer:
    ...
    def _build_reference_model(self):
        ...
        with self.base.hiermoe_placement_disabled():
            ...
            self.reference_model = build_parallelize_model(
                ...
                mixed_precision=MixedPrecisionConfig(
                    enable=False
                ),  # In reference model, we will not use mixed precision
    ...
    def forward_backward_step(
        ...
        with torch.no_grad(), self.base.hiermoe_placement_disabled():
        ...
        with (
            ...
            self.base.hiermoe_layer_swap_forward(),
        ):
