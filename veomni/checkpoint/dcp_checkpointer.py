...
class DistributedCheckpointer(CheckpointerBase):
    ...
    def load(
        ...
        trainable_only: bool = False,
        extra_state_preloaded: bool = False,
    ) -> Dict[str, Any]:
        """
        ...
        args:
            ...
            extra_state_preloaded: whether the caller already loaded and validated
                rank-local extra state before entering the collective tensor load.
    ...
    @classmethod
    def load_extra_state(cls, path: str, state: Dict[str, Any]) -> Dict[str, Any]:
        """Load rank-local metadata before model and optimizer DCP tensors."""
