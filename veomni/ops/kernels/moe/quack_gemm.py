...
from ....distributed.moe.hiermoe import hiermoe_active
    ...
    if get_parallel_state().ep_enabled:
        if hiermoe_active():
            raise NotImplementedError(
                "HierMoE EP token deduplication and Expert Swap placement are not implemented for the quack MoE "
                "backend. Use fused_triton/group_gemm or fused_npu when train.hiermoe.enable=true."
            )
